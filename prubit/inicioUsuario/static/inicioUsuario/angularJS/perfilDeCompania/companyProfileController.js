posts.controller("postsController",function($scope,garmentPostService,commentOfPostsService){
	...
	$.ajax({
		...
		data: {source:source,companyId:companyId},
	...
	$scope.getEndScroll = function(){
		...
		$.ajax({
			...
			data: {"source":source,"companyId":companyId,"postsIdList":JSON.stringify(garmentsCompaniesPostsIdList), "lastPostId": lastPostId},
